...
/* harmony import */ var _helpers_debounce__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../helpers/debounce */ "./src/helpers/debounce.js");
...
class Search {
  ...
  constructor() {
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "events", () => {
      ...
      this.searchField.addEventListener("keyup", this.submitForm); //Keyboard shortcuts
    });

    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "openOverlay", e => {
      this.searchOverlay.classList.add("search-overlay--active"); //adds overflow: hidden to body

      document.querySelector("body").classList.add("body-no-scroll");
      this.searchField.value = ""; //Got to wait until the searchfield is visible- explains the setTimeout

      setTimeout(() => this.searchField.focus(), 301);
      this.isOverlayOpen = true; //This prevents the default behaviour of link elements
    ...
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "keyPressDispatcher", e => {
      if (e.keyCode === 83 && !this.isOverlayOpen && //Only if an input or text area is not focussed
    ...
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "checkFocus", inputs => {
    ...
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "submitForm", e => {
    ...
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(this, "getResults", async () => {
      ...
      <div class="row">
        <div class="one-third">
          ...
          ${data.generalInfo.length ? `<ul class="link-list min-list">
             ${data.generalInfo.map(e => {
          return `<li> <a href="${e.permalink}">${e.title}</a> ${e.postType == "post" ? `by ${e.authorName}` : ""}
                 </li>`;
        }).join("")}
             </ul>
        ...
        <div class="one-third">
          ...
          ${data.programs.length ? `<ul class="link-list min-list">
             ${data.programs.map(e => {
          ...
          ${data.professors.length ? `<ul class="professor-cards">
             ${data.professors.map(e => {
          return `
    ...
    this.searchResults = document.querySelector("#search-overlay__results"); //Call the events method so the browser listens for them as soon as the page is loaded
